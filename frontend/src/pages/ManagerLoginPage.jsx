...
import { managerLogin } from '../api/fleetApi'

export default function ManagerLoginPage({ onSuccess, onBack }) {
        ...
        linear-gradient(90deg, rgba(0,212,255,0.02) 1px, transparent 1px)`,
            ...
            <div className="anim-fade-up" style={{ width: '100%', maxWidth: 380 }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 36 }}>
                    <div style={{
                        width: 64, height: 64,
                        background: 'linear-gradient(135deg, #00D4FF, #0277BD)',
                    ...
                    <p style={{
                        fontSize: 11, color: 'rgba(226,232,240,0.3)', fontWeight: 600,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    ...
                    <button onClick={handleLogin} disabled={loading} style={{
                        background: loading ? 'rgba(0,212,255,0.3)' : 'linear-gradient(135deg, #00D4FF, #0277BD)',
